...
REVIZTO_ACCESS_TOKEN = os.environ.get("REVIZTO_ACCESS_TOKEN", "your_default_token_for_development")
REVIZTO_REFRESH_TOKEN = os.environ.get("REVIZTO_REFRESH_TOKEN", "your_default_refresh_token_for_development")
REVIZTO_LICENCE_UUID = os.environ.get("REVIZTO_LICENCE_UUID", "your_default_licence_uuid_for_development")
